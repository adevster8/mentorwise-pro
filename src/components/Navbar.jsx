...
const [openCategoryIdx, setOpenCategoryIdx] = useState(null); // mobile accordion
...
// click outside of profile dropdown
useEffect(() => {
...
{/* Desktop MegaMenu (unchanged look) */}
<div className="hidden md:block">
<MegaMenuNavbar />
</div>

{/* Mobile slide-in menu + overlay (now includes MegaMenu accordion) */}
<AnimatePresence>
{mobileMenuOpen && (
<>
{/* Overlay */}
