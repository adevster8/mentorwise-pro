...
return (
  <div className="bg-white text-slate-900 shadow-sm border-b border-slate-200 w-full font-lato z-[998] relative">
    <nav className="flex items-center justify-between h-14 px-6 w-full max-w-full">
     

      {/* Center: Categories stretched full width */}
            ...
            <AnimatePresence>
              {openCategory === idx && (
                <motion.div
                  ...
                  className={
                    `absolute top-full mt-0 bg-white border border-slate-200 shadow-2xl rounded-b-2xl p-8 z-10 w-[1120px] max-w-[95vw] ` +
                ...
                >
                  <div className="grid grid-cols-4 gap-x-8 gap-y-6">
                    {cat.topics.map((topic) => (
                      <div key={topic.title}>
                        <h4 className="font-bold text-slate-900 text-base mb-3 tracking-wide">
                          {topic.title}
                        </h4>
