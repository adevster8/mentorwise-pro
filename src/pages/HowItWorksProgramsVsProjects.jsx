...
const QUICK_COMPARE = [
  {
    ...
    programs: "Mentor profile + shareable link (public checkout page).",
    projects: "Private proposal shared in chat; shows in both dashboards.",
  },
  {
    name: "Scope",
    programs: "Pre-defined package (fixed inclusions).",
    projects: "Custom scope (milestones, tasks, links).",
  },
  {
    name: "Pricing / checkout",
    programs: "Instant checkout (one-time, milestone, or monthly).",
    projects: "Accept & pay from a plan card the mentor sends.",
  },
  {
    name: "Best for",
    programs: "Common needs you repeat often.",
    projects: "Unique goals, complex work, or bespoke coaching.",
  },
  {
    name: "Time to start",
    programs: "Fast — buy now.",
    projects: "Short chat → tailored plan → pay.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-blue-50 to-white font-manrope">
      <Helmet>
        ...
        <meta
          name="description"
          content="Understand the difference between Programs and Projects on MentorWise—for clients and mentors. See where each shows up, how checkout works, and when to use which."
        />
      </Helmet>
          ...
          <div className="flex items-center gap-3 py-3 overflow-x-auto">
            {SUB_NAV.map((l, i) => (
              <React.Fragment key={l.href}>
                <a href={l.href} className="text-sm font-semibold text-slate-800 hover:text-orange-600 whitespace-nowrap">
                  {l.label}
                </a>
      ...
      <main>
        ...
        <Section
          ...
          subtitle="Two complementary ways to work on MentorWise. Programs are ready-to-buy packages on a mentor’s profile. Projects are bespoke plans your mentor crafts for your specific goal."
        >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-700">
                    Curated, repeatable offerings with a clear price and what’s included. Great for common needs where you
                    want to get started quickly.
                  </p>
                  <div className="mt-3 flex flex-wrap gap-2">
                    <Pill icon={CreditCardIcon}>Instant checkout</Pill>
                    <Pill icon={LinkIcon}>Public link</Pill>
                ...
                <div>
                  ...
                  <p className="text-slate-700">
                    A tailor-made plan: milestones, tasks, budget, timing, and links. Ideal when your goal needs a custom
                    approach or collaboration.
                  </p>
                  <div className="mt-3 flex flex-wrap gap-2">
                    <Pill icon={ChatBubbleLeftRightIcon}>Discuss in chat</Pill>
                    <Pill icon={ClipboardDocumentCheckIcon}>Plan card</Pill>
                    <Pill icon={CalendarDaysIcon}>Scheduling built-in</Pill>
                  </div>
                </div>
              </div>
            </GlassCard>
        ...
        <Section
          ...
          subtitle="Both paths use the same secure payments and scheduling. Choose what fits your situation."
        >
          <div className="grid md:grid-cols-2 gap-6">
            <motion.div {...fadeUp(0)}>
              <GlassCard className="p-6 h-full">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-lg font-bold text-slate-900">Programs (for Clients)</h3>
                  <Pill icon={BoltIcon}>Fastest</Pill>
                </div>
            ...
            <motion.div {...fadeUp(0.05)}>
              <GlassCard className="p-6 h-full">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-lg font-bold text-slate-900">Projects (for Clients)</h3>
                  <Pill icon={SparklesIcon}>Tailored</Pill>
                </div>
                <ul className="space-y-2 text-slate-700 text-sm">
        ...
        <Section
          id="clients"
          eyebrow="For Clients"
          title="Pick the path that matches your goal"
          subtitle="Both give you structure, accountability, and secure checkout."
        >
          <div className="grid md:grid-cols-2 gap-6">
            <motion.div {...fadeUp(0)}>
              <GlassCard className="p-6">
                <div className="flex items-center gap-2 mb-3">
                  <Squares2X2Icon className="h-6 w-6 text-orange-600" />
                  <h3 className="text-lg font-bold text-slate-900">When to choose Programs</h3>
                </div>
            ...
            <motion.div {...fadeUp(0.05)}>
              <GlassCard className="p-6">
                <div className="flex items-center gap-2 mb-3">
                  <PencilSquareIcon className="h-6 w-6 text-orange-600" />
                  <h3 className="text-lg font-bold text-slate-900">When to choose Projects</h3>
                </div>
                <ul className="space-y-2 text-sm text-slate-700">
        ...
        <Section
          id="mentors"
          eyebrow="For Mentors"
          title="When mentors use each"
          subtitle="Offer both and link them from your profile to capture different kinds of demand."
        >
          <div className="grid md:grid-cols-2 gap-6">
            <motion.div {...fadeUp(0)}>
              <GlassCard className="p-6">
                <div className="flex items-center gap-2 mb-3">
                  <Squares2X2Icon className="h-6 w-6 text-orange-600" />
                  <h3 className="text-lg font-bold text-slate-900">Programs (mentor view)</h3>
                </div>
                <ul className="space-y-2 text-sm text-slate-700">
            ...
            <motion.div {...fadeUp(0.05)}>
              <GlassCard className="p-6">
                <div className="flex items-center gap-2 mb-3">
                  <PencilSquareIcon className="h-6 w-6 text-orange-600" />
                  <h3 className="text-lg font-bold text-slate-900">Projects (mentor view)</h3>
                </div>
                <ul className="space-y-2 text-sm text-slate-700">
              ...
              <motion.div key={row.name} {...fadeUp(i * 0.04)}>
                <GlassCard className="p-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 text-sm">
                    <div>
                      <div className="font-bold text-slate-800 mb-1">Programs</div>
                      <p className="text-slate-700">{row.programs}</p>
                    </div>
                    <div>
                      <div className="font-bold text-slate-800 mb-1">Projects</div>
                      <p className="text-slate-700">{row.projects}</p>
                    </div>
                  </div>
                </GlassCard>
              </motion.div>
        ...
        <Section
          ...
          subtitle="Here’s how clients typically engage."
        >
          <div className="grid md:grid-cols-2 gap-6">
            <motion.div {...fadeUp(0)}>
              <GlassCard className="p-6">
            ...
            <motion.div {...fadeUp(0)}>
              <GlassCard className="p-6">
                ...
                <p className="text-sm text-slate-700">
                  Yes. Start with a Program to get momentum, then ask your mentor to craft a Project plan if you need a
                  deeper or longer engagement.
                </p>
              </GlassCard>
            </motion.div>
            <motion.div {...fadeUp(0.05)}>
              <GlassCard className="p-6">
                ...
                <p className="text-sm text-slate-700">
                  All checkouts run through Stripe with clear deliverables. Milestones and retainers make expectations
                  transparent for both clients and mentors.
                </p>
              </GlassCard>
            </motion.div>
          </div>
        ...
        <Section id="cta" eyebrow="Get started" title="Pick a mentor and choose your path">
          <motion.div {...fadeUp(0)} className="flex flex-wrap items-center gap-3">
            ...
            >
              Find a Mentor <ArrowRightIcon className="h-5 w-5" />
            </Link>
            <Link
              to="/realtalk"
