      ...
      <div className="sticky top-0 z-40 backdrop-blur-xl bg-white/70 border-b border-white/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 py-3 overflow-x-auto">
            ...
            <a className="text-sm font-semibold text-slate-800 hover:text-orange-600" href="#earn">Ways to Earn</a>
            <span className="text-slate-300">•</span>
            <a className="text-sm font-semibold text-slate-800 hover:text-orange-600" href="#flow">Sales Flow</a>
            <span className="text-slate-300">•</span>
            <a className="text-sm font-semibold text-slate-800 hover:text-orange-600" href="#fees">Fees & Payouts</a>
            <span className="text-slate-300">•</span>
            <a className="text-sm font-semibold text-slate-800 hover:text-orange-600" href="#tools">Tools</a>
            <span className="text-slate-300">•</span>
            <a className="text-sm font-semibold text-slate-800 hover:text-orange-600" href="#faq">FAQ</a>
            <span className="text-slate-300">•</span>
            <a className="text-sm font-semibold text-slate-800 hover:text-orange-600" href="#cta">Apply</a>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="flex-1">
                ...
                <p className="text-slate-700 leading-relaxed">
                  Sell coaching your way: one-time gigs, time-based packages, goal-based plans, monthly retainers,
                  or hybrid bundles with courses and templates. Close warm leads directly from chat — then auto-schedule,
                  track progress, and grow repeat business.
                </p>
          ...
          {[
            {
              ...
              points: [
                "Outcome + milestones (no unrealistic guarantees)",
                "Weekly check-ins and homework",
                "Charge once or per-milestone",
              ],
            },
            {
              icon: ArrowPathIcon,
              ...
              points: [
                "e.g., 4 calls/mo + priority DM",
                "Stable recurring revenue",
                "Rollover rules optional",
              ],
            },
            {
              icon: ClockIcon,
              ...
              points: [
                "You sell time, not promises",
                "30/45/60 min sessions",
                "Use-by date & reschedule rules",
              ],
            },
            {
              ...
              points: [
                "Sell digital products alongside coaching",
                "Licensing options (personal/commercial)",
                "Great for upsells after sessions",
              ],
            },
            {
              icon: PlayCircleIcon,
              title: "Bundles",
              points: [
                "Live calls + course + PDFs",
                "Proven for skills like fitness or music",
            ...
            },
            {
              ...
              title: "One-Time Gigs",
              points: [
                "Resume audit, workout plan, channel review",
                "Set delivery time & revisions",
                "Familiar ‘Fiverr-style’ option",
              ],
            },
            {
              icon: BanknotesIcon,
              title: "Token Packs",
              points: [
                "Prepaid credits (e.g., 5×30-min)",
                "Redeem anytime within 6 months",
                "Perfect for on-demand support",
              ],
            },
          ].map((card, i) => (
          ...
          {[
            {
              ...
              title: "Warm Chat",
              body: "Qualify the client, ask for context, and share examples.",
              pill: "No pressure",
            },
            {
              icon: RocketLaunchIcon,
              title: "Plan Card",
              body: "Compose a clear plan with scope, schedule windows, and price.",
              pill: "Polished",
            },
            {
              icon: CreditCardIcon,
              title: "Checkout",
              body: "Stripe-powered. One-time, milestones, or monthly.",
              pill: "Protected",
            },
            {
              icon: CalendarDaysIcon,
              title: "Auto-Schedule",
              body: "Instant calendar sync. Clear reschedule rules.",
              pill: "Instant",
            },
            {
              icon: ChartBarIcon,
              title: "Track & Upsell",
              body: "Session notes, homework, and smart upsells to bundles/products.",
              pill: "Sticky",
            },
          ].map((s, i) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              <div className="grid grid-cols-2 gap-3">
                {[
                  { icon: BoltIcon, label: "Fast setup" },
                  { icon: ChatBubbleLeftRightIcon, label: "DM → Plan" },
                  { icon: CalendarDaysIcon, label: "Auto scheduling" },
                  { icon: CreditCardIcon, label: "Secure payouts" },
                ].map((x) => (
              ...
              <div className="mt-4 rounded-xl border border-slate-200 bg-white/70 p-4">
                ...
                <div className="mt-2 text-xs text-slate-500">
                  See exactly how clients chat, accept plans, and book you.
                </div>
              </div>
            </div>
          </div>
          ...
          {[
            {
              icon: StarIcon,
              title: "Trust & Reviews",
              body: "Verified badges, response time, and session counts help you stand out.",
            },
            {
              icon: UserGroupIcon,
              title: "RealTalk Community",
              body: "Share advice, run AMAs, and turn helpful posts into warm leads.",
            },
            {
              icon: PlayCircleIcon,
              title: "Zoom-ready Sessions",
              body: "Checkout auto-creates links and syncs to calendars. Notes after each call.",
            },
            {
              icon: ArrowTrendingUpIcon,
              title: "Upsells & Bundles",
              body: "Offer product add-ons and turn custom plans into public listings.",
            },
            {
              icon: ClockIcon,
              title: "Smart Availability",
              body: "Offer recurring windows or ad-hoc slots. Clear reschedule rules.",
            },
            {
              icon: CreditCardIcon,
              title: "Flexible Payments",
              body: "One-time, milestone, or monthly retainers. Stripe protection built-in.",
            },
          ].map((f, i) => (
          ...
          {[
            {
              ...
              a: "Live coaching (time-based, retainers, goals), one-time gigs, token packs, and digital products like courses, templates, or recordings. Bundles are encouraged.",
            },
            {
              q: "Do you guarantee outcomes?",
              a: "No. Coaching is best-effort. Plans use milestones and accountability, but results depend on client participation and practice.",
            },
            {
              q: "How do payouts work?",
              a: "Stripe powers checkout and payouts. Most bank accounts are supported. You’ll see net earnings after fees in your dashboard.",
            },
            {
              q: "What about scheduling and reschedules?",
              a: "You control availability windows, buffers, and reschedule rules. Clients see the policy before paying.",
            },
          ].map((f, i) => (
