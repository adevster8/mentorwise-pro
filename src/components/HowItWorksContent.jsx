...
const SUB_NAV_LINKS = [
  ...
  { href: "#paths", label: "Coaching Paths" },
  { href: "#flow", label: "From Chat → Plan" },
  { href: "#compare", label: "Compare" },
  { href: "#ui", label: "What You Get" },
  { href: "#faq", label: "FAQ" },
...
const COACHING_PATHS = [
  {
    ...
    description: "Commit to a clear outcome with milestones and weekly check-ins.",
    features: [
      "Example: Play 3 full songs in 4 weeks.",
      "Weekly milestones + homework + feedback.",
      "Pay once or per-milestone.",
    ],
  },
  {
    icon: ArrowPathIcon,
    title: "Retainer Coaching",
    description: "Ongoing support with a monthly package—perfect for accountability.",
    features: [
      "4 calls / month + priority chat Q&A.",
      "Pause, resume, or upgrade anytime.",
      "Optional rollover of unused time.",
    ],
  },
  {
    icon: AcademicCapIcon,
    title: "Learning-Based Coaching",
    description: "Skill-first with a flexible pace. Mix live sessions with resources.",
    features: [
      "Curriculum + live practice sessions.",
      "Add sessions when you need them.",
      "Bundle with courses/templates.",
    ],
  },
];
...
const PATH_COMPARISONS = [
  {
    name: "Goal-Based",
    points: ["Clear milestones & timelines", "One-time or milestone payments", "Great for deadlines and launches"],
    badge: "Great for outcomes",
  },
  {
    name: "Retainer",
    points: ["Monthly package (e.g., 4 calls + Q&A)", "Priority access and continuity", "Pause / resume any month"],
    badge: "Great for accountability",
  },
  {
    name: "Learning-Based",
    points: ["Curriculum + live practice", "Flexible pace and add-on sessions", "Perfect for skills & creativity"],
        ...
        <motion.div key={path.title} {...fadeUp(i * 0.05)}>
          <GlassCard className="h-full p-6">
            <div className="flex items-center gap-3 mb-3">
              <path.icon className="h-6 w-6 text-orange-600" />
