...
// Added "Programs" link + dashboard card.
const sidebarLinks = [
  ...
  { name: "Programs", path: "/mentor-dashboard/programs", icon: FileText },
  { name: "Create Program", path: "/mentor-dashboard/programs/create", icon: PlusCircle }, // ⬅️ add this
...
const dashboardCards = [
  ...
  { title: "Programs", value: "Create & share", to: "/mentor-dashboard/programs", icon: FileText, desc: "Curate offerings and launch checkout." }, // NEW
